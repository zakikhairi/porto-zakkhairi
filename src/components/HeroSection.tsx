...
export const HeroSection: React.FC<HeroProps> = ({ profile }) => {
  ...
  return (
    <section id="home" className="relative min-h-[calc(100vh-4rem)] pt-16 pb-0 flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 flex-1 flex flex-col justify-center py-6">
        <div className="spidey-hero-grid">
          {/* Column 1: Left Intro */}
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-3.5 order-1">
            <p className="font-mono text-xs sm:text-sm text-[#a9bcec] tracking-widest uppercase flex items-center gap-2">
              <Terminal className="w-4 h-4 text-cyan-400" />
              <span>// hello, saya</span>
            </p>

            <h1 className="font-bungee text-4xl sm:text-5xl lg:text-[60px] text-white spidey-text-3d leading-[1.05] tracking-wide my-1 transition-all">
              M.<br />
              ZAKI<br />
              KHAIRI
            </h1>
            ...
            <div className="border-l-4 border-[#e62429] bg-gradient-to-r from-red-600/25 via-blue-900/25 to-slate-900/40 p-3 rounded-r-lg max-w-sm my-1 border-y border-r border-[#0B1440] shadow-[3px_3px_0px_#0B1440] backdrop-blur-md">
              <p className="font-mono text-[11px] sm:text-xs text-yellow-300 font-bold mb-1 flex items-center justify-center lg:justify-start gap-1.5">
                <span>🕷️</span>
                <span>{ROLE_ITEMS[roleIndex].title}</span>
              </p>
              <p className={`text-xs text-slate-200 leading-snug transition-all duration-300 ${
          ...
          <div className="flex flex-col items-center justify-center relative min-h-[440px] order-2">
            {/* Arched Marvel Logo */}
            <div className="spidey-logo mb-1 select-none pointer-events-none">
            ...
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#e62429] text-white text-[11px] font-anton tracking-wide border-2 border-[#0B1440] shadow-[3px_3px_0px_#0B1440] absolute top-14 -left-4 z-20 animate-float-slow select-none pointer-events-none">
              <span>🕷️ SPIDER-SENSE 100%</span>
            </div>

            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#1e5fb0] text-white text-[11px] font-anton tracking-wide border-2 border-[#0B1440] shadow-[3px_3px_0px_#0B1440] absolute top-20 -right-4 z-20 animate-float-reverse select-none pointer-events-none">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-3.5 order-3">
            <p className="font-mono text-xs text-[#a9bcec] font-bold tracking-[0.15em] uppercase">
              // ABOUT ME
            </p>

            <p className="font-mono text-xs sm:text-sm text-[#e9dfc9] leading-relaxed max-w-sm">
            ...
            <div className="pt-1">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2">
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#0a4aa3] border-2 border-[#0B1440] shadow-[2px_2px_0px_#0B1440] flex items-center justify-center text-white hover:bg-pink-600 hover:-translate-y-1 transition-all"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#0a4aa3] border-2 border-[#0B1440] shadow-[2px_2px_0px_#0B1440] flex items-center justify-center text-white hover:bg-cyan-600 hover:-translate-y-1 transition-all"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#0a4aa3] border-2 border-[#0B1440] shadow-[2px_2px_0px_#0B1440] flex items-center justify-center text-white hover:bg-red-600 hover:-translate-y-1 transition-all"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#0a4aa3] border-2 border-[#0B1440] shadow-[2px_2px_0px_#0B1440] flex items-center justify-center text-white hover:bg-purple-600 hover:-translate-y-1 transition-all"
                >
            ...
            <div className="w-full max-w-xs pt-1">
              <div className="rounded-xl p-2 bg-slate-950/80 border-2 border-[#0B1440] shadow-[3px_3px_0px_#0B1440] flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <button
                    onClick={toggleMusic}
                    className="w-7 h-7 rounded-lg bg-red-600 flex items-center justify-center text-white cursor-pointer hover:scale-105 transition"
                  >
                    {isPlayingLofi ? <Pause className="w-3.5 h-3.5" /> : <Play className="w-3.5 h-3.5 ml-0.5" />}
                  </button>
                  <div>
                    <span className="text-[11px] font-bold text-white block">Lo-Fi Coding Beat</span>
                    <span className="text-[10px] text-slate-400 block">{isPlayingLofi ? '84 BPM • Suasana Fokus' : 'Klik putar musik'}</span>
                  </div>
                </div>
      ...
      {/* Infinite Scrolling Comic Marquee Ticker at bottom of hero */}
      <div className="relative w-full mt-6 h-13 sm:h-15 bg-[#e62429] border-t-[4px] border-[#ff7b00] overflow-hidden shadow-[0_-5px_20px_rgba(0,0,0,0.5)] z-20 flex items-center">
